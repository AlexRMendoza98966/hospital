...
import { createCasoClinico } from "./actions";
...
function SubmitButton() {
    ...
    return (
        ...
        >
            {pending ? "Guardando..." : "Guardar Caso Clínico"}
        </button>
    );
}

export default function AddCasoModal({ onSuccess }: { onSuccess?: () => void }) {
    const [isOpen, setIsOpen] = useState(false);
    const [state, formAction] = useActionState(createCasoClinico, null);
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl animate-in fade-in zoom-in duration-200 overflow-hidden">
                        ...
                        <div className="flex justify-between items-center p-4 border-b bg-blue-600 text-white">
                            <h2 className="text-xl font-bold uppercase tracking-tight">Registro Caso Clínico</h2>
                            <button
                            ...
                            <form action={formAction} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        name="nombre_informe"
                                        required
                                        placeholder="Ej: Análisis de neumonía pediátrica"
