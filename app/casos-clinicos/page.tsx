...
import { Eye, Download, FileText, Calendar, Search, Trash2, Microscope } from "lucide-react";
import AddCasoModal from "./AddCasoModal";
import { getCasosClinicos, deleteCasoClinico } from "./actions";
...
export default function CasosClinicosPage() {
    ...
    const handleDelete = async (id: number) => {
        if (confirm("¿Estás seguro de que quieres eliminar este caso clínico?")) {
            const res = await deleteCasoClinico(id);
            if (res.success) {
                fetchReports();
            } else {
                alert(res.message);
            ...
            <div className="bg-blue-900 text-white py-16 px-4">
                <div className="max-w-7xl mx-auto text-center space-y-4">
                    ...
                    <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                        Documentación técnica y académica de casos clínicos institucionales.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 -mt-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg mb-8 flex flex-col md:flex-row gap-4 items-center justify-between border border-gray-100">
                    ...
                    <div className="flex gap-2 w-full md:w-auto">
                        <AddCasoModal onSuccess={handleSuccess} />
                    </div>
                </div>
                ...
                {filteredReports.length === 0 && (
                    <div className="text-center py-20 bg-white rounded-xl shadow-sm border border-dashed border-gray-300">
                        ...
                        <h3 className="text-lg font-medium text-gray-900">No se encontraron casos clínicos</h3>
