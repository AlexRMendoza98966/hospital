...
import { Eye, Download, FileText, Calendar, Search, Trash2, PieChart } from "lucide-react";
import AddRendicionModal from "./AddRendicionModal";
import { getRendicionesCuentas, deleteRendicionCuentas } from "./actions";
...
export default function RendicionCuentasPage() {
    ...
    const fetchReports = useCallback(() => {
        getRendicionesCuentas().then(data => {
    ...
    const handleDelete = async (id: number) => {
        if (confirm("¿Estás seguro de que quieres eliminar este informe?")) {
            const res = await deleteRendicionCuentas(id);
            if (res.success) {
                fetchReports();
            } else {
                alert(res.message);
            ...
            <div className="bg-blue-900 text-white py-16 px-4">
                <div className="max-w-7xl mx-auto text-center space-y-4">
                    ...
                    <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                        Cumplimiento de la política nacional de transparencia y lucha contra la corrupción.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 -mt-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg mb-8 flex flex-col md:flex-row gap-4 items-center justify-between border border-gray-100">
                    ...
                    <div className="flex gap-2 w-full md:w-auto">
                        <AddRendicionModal onSuccess={handleSuccess} />
                    </div>
                </div>
